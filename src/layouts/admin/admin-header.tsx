...
import { LogOut, User, Menu, Bell, Shield, Home } from 'lucide-react';
...
export function AdminHeader() {
  ...
  return (
    <header className="sticky top-0 z-40 flex h-16 items-center gap-4 border-b border-gray-200 bg-white px-4 sm:px-6">
      ...
      {/* Logo */}
      <Link href={ROUTES.ADMIN.HOME} className="flex items-center gap-2">
        ...
        <div className="hidden sm:flex items-center gap-1.5 ml-2 px-2 py-0.5 bg-indigo-100 text-indigo-700 rounded text-xs font-medium">
      ...
      <div className="flex items-center gap-2">
        ...
        <Popover>
          <PopoverTrigger asChild>
            ...
            >
              <div className="h-8 w-8 rounded-full bg-indigo-600 flex items-center justify-center text-sm font-medium text-white overflow-hidden">
                {user?.avatarUrl ? (
                  <Image
                    src={user.avatarUrl}
